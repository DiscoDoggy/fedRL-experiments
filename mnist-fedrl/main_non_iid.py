...
def main():
    ...
    try:
        for k in clients_per_round:
            ...
            results_parent_path: str = f'results_for_runs_mnist_fedrl_fairness_ablated'
            ...
            plt.subplot(2, 4, 1)
            plt.plot(range(1, actual_rounds + 1), accuracies, 'b-', linewidth=2, marker='o')
            ...
            plt.subplot(2, 4, 2)
            plt.plot(range(1, actual_rounds + 1), losses, 'orange', linewidth=2, marker='d')
            ...
            plt.subplot(2, 4, 3)
            plt.plot(range(1, actual_rounds + 1), rewards, 'r-', linewidth=2, marker='s')
