...
class DQN_Agent:
    """DQN Agent for Client Selection (Single DQN)."""
    def __init__(self, state_size, action_size):
        self.model = DQN(state_size, action_size)
        # self.target_model = DQN(state_size, action_size)  # Commented out for Single DQN
        self.optimizer = optim.Adam(self.model.parameters(), lr=0.01)
        self.loss_fn = nn.MSELoss()

        # self.eps_start = 0.8      # or 1.0
        # self.eps_end = 0.05
        # self.eps_decay_episodes = 150  # decay over first 150 episodes
        # self.episode = 0
    ...
    #     self.epsilon = (
    #         self.eps_start
    #         - frac * (self.eps_start - self.eps_end)
    #     )
    ...
    def train(self, state, action, reward, next_state):
        """Train the Q-network (Single DQN)."""
        ...
        # Use self.model instead of self.target_model for Single DQN
