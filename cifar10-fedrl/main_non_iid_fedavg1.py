...
from models import SimpleNN, SimpleMNISTCNN, ResNetFed
...
def main():
    ...
    try:
        for k in clients_per_round: 
            ...
            results_parent_path: str = f'results_for_runs_cifar_fedavg'
            ...
            cifar_fedavg_runs_pth = 'cifar_fedavg_runs'
            ...
            for epoch in range(num_rounds):
                ...
                logging.info(f"FedAVG Random Selected clients for training: {selected_client_idxs}")
            ...
            if epoch % 50 == 0 and epoch != 0:
                try:
                    save_server_model(server, f'{cifar_fedavg_runs_checkpoint}/global_model_chkpt_round_{epoch}.pt')
                except Exception as e:
                    logging.warning(f"Failed to save model at round {epoch}: {e}")
            # ==================== RESULTS ====================
