...
class Client(object):
    ...
    def __init__(self, client_name, local_dataset, local_model, numbercores , frequency, bandwidth, loss, B, learning_rate, momentum, device=None):
        """
        ...
        self.loss_func = loss
        # the optimizer - Use Adam with lr=0.001 to match FedRL (works better with ResNet + non-IID FL)
        self.optimizer = torch.optim.Adam(self.local_model.parameters(), lr=0.001, weight_decay=1e-4)
