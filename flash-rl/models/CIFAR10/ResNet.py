...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'resnet1202', 'ResNetFed']
...
class ResNetFed(nn.Module):
    """Modified ResNet-18 for CIFAR-10 from FedRL.
    ...
    - Final FC layer adjusted for 10 classes
    """
    def __init__(self, num_classes=10):
        ...
        # Remove maxpool layer (not needed for small images)
